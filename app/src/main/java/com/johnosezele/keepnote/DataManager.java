...
import com.johnosezele.keepnote.NoteKeeperDatabaseContract.CourseInfoEntry;
...
//   method for issuing query to database, loading up the list of courses & notes below better put,
//the purpose of this method is to read our courses from course_info table, put it into a list in the
//    DataManager, then read our notes from the note_info table and put the value into a list in the DM.
