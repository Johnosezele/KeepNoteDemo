...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private static final String TAG = "nav activity";
...
//   This method initializeDisplayContent() is responsible for displaying notes in the RecyclerView.
        mMRecyclerItems = findViewById(R.id.list_items); //Reference to RecyclerView
        mNotesLayoutManager = new LinearLayoutManager(this); //Creates LayoutManager we use with our notes.
        mCoursesLayoutManager = new GridLayoutManager(this, getResources().getInteger(R.integer.course_grid_span));

        List<NoteInfo> notes = DataManager.getInstance().getNotes();
        mNoteRecyclerAdapter = new NoteRecyclerAdapter(this, notes);//Create Adapter we use with our notes.
...
//      Associate layoutManager in the adapter with the RecyclerView in our displayNotes() method.
